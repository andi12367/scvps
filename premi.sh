...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Welcome To Script TEMPEST TUNNELING${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e "  Auther : ${green}TEMPEST® ${NC}${YELLOW}(${NC} ${green} TEMPEST TUNNELING ${NC}${YELLOW})${NC}"
echo -e " © DEV RanTempest${YELLOW}(${NC} 2024 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC
...
today=`date https://raw.githubusercontent.com/andi12367/scvps/main/izin | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
wget https://raw.githubusercontent.com/andi12367/scvps/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
