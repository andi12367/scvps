...
echo -e "  Auther : ${green}TEMPESTt® ${NC}${YELLOW}(${NC} ${green} TEMPEST vpn Tunneling ${NC}${YELLOW})${NC}"
...
wget raw.githubusercontent.com/andi12367/scvps/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
