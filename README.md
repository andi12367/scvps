...
### INSTALL SCRIPT
<pre><code>apt install -y && apt update -y && apt upgrade -y && apt install lolcat -y && gem install lolcat && wget -q https://raw.githubusercontent.com/andi12367/scvps/main/main.sh && chmod +x main.sh && ./main.sh
</code></pre>
